#!/usr/bin/env python3
"""Synthesize the diacritized benchmark sentences with
karim23657/persian-tts-female-GPTInformal-Persian-vits.

A/B pair for run_karim_gptinformal_vits.py: same model, diacritized input
(sentences_diacritized.txt — Full TTS front-end: digits→words, Ezafe kasra, harakat).
Run with the coqui venv:  .venvs/coqui/bin/python scripts/run_karim_gptinformal_vits_diac.py
Output: docs/audio/karim-gptinformal-vits-diac/NN.wav
"""
import os
import re
import time
...
CFG = "config.json"
FOLDER = "karim-gptinformal-vits-diac"
