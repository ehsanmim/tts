#!/usr/bin/env python3
"""Synthesize the Persian benchmark sentences with Kamtera/persian-tts-male-vits.

Model:  https://huggingface.co/Kamtera/persian-tts-male-vits  (Coqui VITS)
Engine: Coqui TTS (coqui-tts) + espeak-ng phonemizer (fa)
Run with the coqui venv:  .venvs/coqui/bin/python scripts/run_kamtera_male_vits.py
Output: docs/audio/kamtera-male-vits/NN.wav
"""
import os
import re
import time
