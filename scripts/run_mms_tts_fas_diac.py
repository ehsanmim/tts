#!/usr/bin/env python3
"""Synthesize the diacritized benchmark sentences with facebook/mms-tts-fas.

A/B pair for run_mms_tts_fas.py: same model, diacritized input
(sentences_diacritized.txt — Full TTS front-end: digits→words, Ezafe kasra, harakat).
Output: docs/audio/mms-tts-fas-diac/NN.wav  (16 kHz)
"""
import os
import re
import time
...
OUT_DIR = os.path.join(HERE, "docs", "audio", "mms-tts-fas-diac")
