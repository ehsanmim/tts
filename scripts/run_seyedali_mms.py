#!/usr/bin/env python3
"""Synthesize the Persian benchmark sentences with SeyedAli/Persian-Speech-synthesis-MMS.

Model:  https://huggingface.co/SeyedAli/Persian-Speech-synthesis-MMS  (VITS, MMS-style)
Engine: 🤗 transformers  (VitsModel — same path as facebook/mms-tts-fas)
Output: docs/audio/seyedali-mms/NN.wav
"""
import os
import re
import time
