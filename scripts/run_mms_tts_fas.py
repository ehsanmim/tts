#!/usr/bin/env python3
"""Synthesize the Persian benchmark sentences with facebook/mms-tts-fas.

Model:  https://huggingface.co/facebook/mms-tts-fas  (Meta MMS, VITS)
Engine: 🤗 transformers  (no espeak / phonemizer binary needed)
Output: samples/mms-tts-fas/NN.wav  (16 kHz)
"""
import os
import re
import time
...
OUT_DIR = os.path.join(HERE, "docs", "audio", "mms-tts-fas")
