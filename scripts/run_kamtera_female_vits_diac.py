#!/usr/bin/env python3
"""Synthesize the diacritized benchmark sentences with Kamtera/persian-tts-female-vits.

A/B pair for run_kamtera_female_vits.py: same model, diacritized input
(sentences_diacritized.txt — Full TTS front-end: digits→words, Ezafe kasra, harakat).
Run with the coqui venv:  .venvs/coqui/bin/python scripts/run_kamtera_female_vits_diac.py
Output: docs/audio/kamtera-female-vits-diac/NN.wav
"""
import os
import re
import time
...
CKPT = "best_model_30824.pth"
CFG = "config.json"
FOLDER = "kamtera-female-vits-diac"
