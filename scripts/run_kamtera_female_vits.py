#!/usr/bin/env python3
"""Synthesize the Persian benchmark sentences with Kamtera/persian-tts-female-vits.

Model:  https://huggingface.co/Kamtera/persian-tts-female-vits  (Coqui VITS)
Engine: Coqui TTS (coqui-tts) + espeak-ng phonemizer (fa)
Run with the coqui venv:  .venvs/coqui/bin/python scripts/run_kamtera_female_vits.py
Output: samples/kamtera-female-vits/NN.wav
"""
import os
import re
import time
...
CKPT = "best_model_30824.pth"   # highest-step checkpoint in the repo
CFG = "config.json"
FOLDER = "kamtera-female-vits"
